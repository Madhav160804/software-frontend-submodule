...
const PreferenceViewingPageminor = () => {
    const clusters = {
        cluster1: [
          { name: 'Deepika', roll: '232IT005', cg: 9.2 },
        ],
        cluster2: [
          { name: 'Anil', roll: '232IT008', cg: 9.0 },
          { name: 'Surya', roll: '221IT090', cg: 8.9 },
        ],
        cluster3: [
          { name: 'Sonam', roll: '232IT044', cg: 8.1 },
          { name: 'Aman', roll: '232IT041', cg: 7.5 },
          { name: 'Yash', roll: '232IT031', cg: 7.7 },
        ],
        cluster4: [
          { name: 'Ayush', roll: '232IT087', cg: 7.6 },
        ],
      };
...
export default PreferenceViewingPageminor;
